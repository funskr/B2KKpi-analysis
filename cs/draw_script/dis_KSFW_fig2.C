...
void dis_KSFW_fig2(){
    ...
    ifstream f;
    f.open("/home/belle2/yuanmk/analysis/B2KKpi/continuum/draw_script/KSFW_variables2.conf", ios::in);
    if(f.is_open()){
    ...
    string pdf = "./dis_KSFW_fig2.pdf";
    string png = "./dis_KSFW_fig2.png";
