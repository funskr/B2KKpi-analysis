...
void dis_deltaE(){
    ...
    // set ytitle
    Double_t xmin=-0.3, xmax=0.2;  Double_t xbins=100;
    ...
    draw_hist(hBBbar,"/home/belle2/yuanmk/analysis/B2KKpi/topoana/bbar_MC.root","B0","deltaE");
    ...
    for(int i=0; i<10; i++){
        ...
        draw_hist(hc_ind[i], "/home/belle2/yuanmk/analysis/B2KKpi/topoana/bbar_MC.root", "B0", "deltaE", false, iCaseDcyBrP[i]);
        cout<<iCaseDcyBrP[i]<<":"<<hc_ind[i]->GetEntries()<<endl;
        hc->Add(hc_ind[i]);
    }
    //hc->Add(hc_ind[1]);
    ...
    hBBbar->GetXaxis()->SetTitle("#Delta E(GeV)");
    ...
    TLegend *legend = new TLegend(0.70,0.60,0.86,0.86);
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/plots/bkg_bbar/png/dis_deltaE.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/plots/bkg_bbar/pdf/dis_deltaE.pdf");
