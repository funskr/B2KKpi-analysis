...
void dis_deltaE(){
    ...
    // set ytitle
    Double_t xmin=-0.3, xmax=0.15;  Double_t xbins=100;
    ...
    draw_hist(hBBbar,"/home/belle2/yuanmk/data/B2KKpi/sample/ana/mixed_sample.root","B0","deltaE");
    draw_hist(hBBbar,"/home/belle2/yuanmk/data/B2KKpi/sample/ana/charged_sample.root","B0","deltaE");
