void BBar_sample(){
    ...
    chain->Add("/home/belle2/yuanmk/data/B2KKpi/BBbar/B2KKpi_mixed_20230719_12/sub00/*.root");
    chain->Add("/home/belle2/yuanmk/data/B2KKpi/BBbar/B2KKpi_mixed_20230719_12/sub01/*.root");
    chain->Add("/home/belle2/yuanmk/data/B2KKpi/BBbar/B2KKpi_mixed_20230719_12/sub02/*.root");
    ...
    TFile* file = new TFile("/home/belle2/yuanmk/data/B2KKpi/BBbar/BBar_sample.root","recreate");
    tree->Write();
    file->Close();
}