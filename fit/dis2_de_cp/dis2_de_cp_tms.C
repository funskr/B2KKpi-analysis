...
void dis2_de_cp_tms(){
    ...
    pt->AddText("Truth-matched signal MC");
    pt->Draw();

    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/plots/correlation_deltaE_contProb_trans/pdf/dis2_de_cp_tms.pdf");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/plots/correlation_deltaE_contProb_trans/png/dis2_de_cp_tms.png");
}