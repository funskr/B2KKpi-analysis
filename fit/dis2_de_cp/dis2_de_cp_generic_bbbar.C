...
void dis2_de_cp_generic_bbbar(){
    ...
    Double_t ymin = -3; Double_t ymax = 3; Int_t ybins = 100;
    ...
    pt->AddText("mixed and charged MC");
    pt->Draw();

    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/plots/correlation_deltaE_contProb_trans/pdf/dis2_de_cp_generic_bbbar.pdf");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/plots/correlation_deltaE_contProb_trans/png/dis2_de_cp_generic_bbbar.png");
}