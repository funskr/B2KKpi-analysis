...
void dis_dz(){
    ...
    draw_hist(hsigMC,"/home/belle2/yuanmk/analysis/B2KKpi/sigMC/ana_B2KKpi_signalMC_final.root","B0","dz", true);

    TH1D *hmisid=new TH1D("hmisid", "hmisid", xbins, xmin, xmax);
    hmisid->SetLineColor(kBlue);
    hmisid->SetLineWidth(2);
    draw_hist(hmisid,"/home/belle2/yuanmk/analysis/B2KKpi/sigMC/ana_B2KKpi_signalMC_final.root","B0","dz", false);
    ...
    hsigMC->GetXaxis()->SetTitle("dz(cm)");
    ...
    TArrow *xy1 = new TArrow(0.2, 0, 0.2, 1e-3,0.015,"<");
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/png/dis_dz.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/pdf/dis_dz.pdf");
}
