...
void dis_dr(){
    ...
    // set ytitle
    Double_t xmin=0, xmax=0.1;  Double_t xbins=100;
    ...
    draw_hist(hsigMC,"/home/belle2/yuanmk/analysis/B2KKpi/sigMC/ana_B2KKpi_signalMC_final.root","B0","dr", true);

    TH1D *hmisid=new TH1D("hmisid", "hmisid", xbins, xmin, xmax);
    hmisid->SetLineColor(kBlue);
    hmisid->SetLineWidth(2);
    draw_hist(hmisid,"/home/belle2/yuanmk/analysis/B2KKpi/sigMC/ana_B2KKpi_signalMC_final.root","B0","dr", false);
    ...
    hsigMC->GetXaxis()->SetTitle("dr(cm)");
    ...
    TArrow *xy1 = new TArrow(0.04, 0, 0.04, 1e-3,0.015,"<");
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/png/dis_dr.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/pdf/dis_dr.pdf");
}
