...
void dis_FBDT_qr(){
    ...
    h_B0->SetLineWidth(2);
    draw_hist(h_B0,"/home/belle2/yuanmk/data/B2KKpi/sample/sigMC_sample.root","B0","FBDT_qrCombined", 1);

    TH1D *h_B0bar=new TH1D("h_B0bar", "h_B0bar", xbins, xmin, xmax);
    h_B0bar->SetLineColor(kBlue);
    h_B0bar->SetLineWidth(2);
    draw_hist(h_B0bar,"/home/belle2/yuanmk/data/B2KKpi/sample/sigMC_sample.root","B0","FBDT_qrCombined", 2);

    TH1D *h_other=new TH1D("h_other", "h_other", xbins, xmin, xmax);
    h_other->SetLineColor(kGreen);
    h_other->SetLineWidth(2);
    draw_hist(h_other,"/home/belle2/yuanmk/data/B2KKpi/sample/sigMC_sample.root","B0","FBDT_qrCombined", 3);
    ...
    h_B0->GetXaxis()->SetTitle("qr_{FBDT}");
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/png/dis_FBDT_qr.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/pdf/dis_FBDT_qr.pdf");
