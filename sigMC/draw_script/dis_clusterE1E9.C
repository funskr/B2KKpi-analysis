...
void draw_hist(TH1D* hist,string address, string file, bool flag=true){
    ...
    Double_t gamma1_clusterE1E9, gamma2_clusterE1E9;
    chain->SetBranchAddress("gamma1_clusterE1E9", &gamma1_clusterE1E9);
    chain->SetBranchAddress("gamma2_clusterE1E9", &gamma2_clusterE1E9);   
    ...
    for(Int_t i=0; i < nentries; i++){
        ...
        if(flag){
            if(isSignal == 1){
                ...
                hist->Fill(gamma1_clusterE1E9);
                hist->Fill(gamma2_clusterE1E9);
            } 
        }
        else if(!flag){
...
void dis_clusterE1E9(){
    ...
    hsigMC->GetXaxis()->SetTitle("clusterE1E9");
    ...
    TArrow *xy1 = new TArrow(0.3, 0, 0.3, hsigMC->GetMaximum()*0.3,0.015,"<");
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/png/dis_clusterE1E9.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/pdf/dis_clusterE1E9.pdf");
}