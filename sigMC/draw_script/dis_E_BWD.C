...
void dis_E_BWD(){
    ...
    hsigMC->GetXaxis()->SetTitle("clusterE in BWD(GeV)");
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/png/dis_E_BWD.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/pdf/dis_E_BWD.pdf");
}
