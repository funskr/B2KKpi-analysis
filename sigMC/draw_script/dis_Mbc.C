...
void draw_hist(TH1D* hist,string address, string file, string variable, bool flag=true){
    ...
    for(Int_t i=0; i < nentries; i++){
        ...
        //if(pi0_daughterAngle_0_1>0.6) continue;
...
void dis_Mbc(){
    ...
    // set ytitle
    Double_t xmin=5.22, xmax=5.30;  Double_t xbins=100;
    ...
    draw_hist(hsigMC,"/home/belle2/yuanmk/data/B2KKpi/sample/sigMC_sample.root","B0","Mbc", true);
    ...
    draw_hist(hmisid,"/home/belle2/yuanmk/data/B2KKpi/sample/sigMC_sample.root","B0","Mbc", false);
    ...
    hc->GetXaxis()->SetTitle("M_{bc}/(GeV/c^{2})");
