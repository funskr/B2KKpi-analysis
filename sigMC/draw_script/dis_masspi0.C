...
void dis_masspi0(){
    ...
    // set ytitle
    Double_t xmin=0.08, xmax=0.18;  Double_t xbins=100;
    ...
    draw_hist(hsigMC,"/home/belle2/yuanmk/analysis/B2KKpi/sigMC/ana_B2KKpi_signalMC_pion_mass.root","B0","pi0_InvM", true);

    TH1D *hmisid=new TH1D("hmisid", "hmisid", xbins, xmin, xmax);
    hmisid->SetLineColor(kBlue);
    hmisid->SetLineWidth(2);
    draw_hist(hmisid,"/home/belle2/yuanmk/analysis/B2KKpi/sigMC/ana_B2KKpi_signalMC_pion_mass.root","B0","pi0_InvM", false);
    ...
    hsigMC->GetXaxis()->SetTitle("mass of #pi^{0}(GeV/c^{2})");
    ...
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/png/dis_masspi0.png");
    mbc->SaveAs("/home/belle2/yuanmk/analysis/B2KKpi/sigMC/plots/pdf/dis_masspi0.pdf");
}
